  ...
  return (
    <header className="text-white flex justify-between items-start p-2 ">
      ...
      <div className="flex items-center justify-center gap-5">
        <a className="text-[14px]" href="https://mail.google.com/mail/?tab=rm&ogbl">Gmail</a>
        <a className="text-[14px]" href="https://www.google.com/imghp?hl=en&tab=ri&ogbl">Images</a>
